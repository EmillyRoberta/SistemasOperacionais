...
#define PT_DIRTY 2            // Página dirty(M)
#define PT_REFERENCE_BIT 3    // Bit de referencia (R)
         ...
         int fifo_frm, int num_frames, int clock)
{
    ...
    {
        if(page_table[i][PT_FRAMEID] == fifo_frm) //quando o endereco de memoria for igual a primeira moldura acessada
        {
            return i;
        }
    }
